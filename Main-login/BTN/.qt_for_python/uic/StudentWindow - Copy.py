...
################################################################################
## Form generated from reading UI file 'StudentWindow - Copy.ui'
##
...
"}")
        ...
        self.TextStdID_Insert = QLineEdit(self.widget)
        self.TextStdID_Insert.setObjectName(u"TextStdID_Insert")
        self.TextStdID_Insert.setGeometry(QRect(280, 580, 171, 41))
        self.TextStdID_Insert.setFont(font1)
        self.TextStdID_Insert.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom:2px solid rgba(105,118,132,255);\n"
"color:rgba(255,255,255,230);\n"
"padding-bottom:7px;")
        self.TextStdName_Insert = QLineEdit(self.widget)
        self.TextStdName_Insert.setObjectName(u"TextStdName_Insert")
        self.TextStdName_Insert.setGeometry(QRect(470, 580, 171, 41))
        self.TextStdName_Insert.setFont(font1)
        self.TextStdName_Insert.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom:2px solid rgba(105,118,132,255);\n"
"color:rgba(255,255,255,230);\n"
"padding-bottom:7px;")
        self.TextStdAddress_Insert = QLineEdit(self.widget)
        self.TextStdAddress_Insert.setObjectName(u"TextStdAddress_Insert")
        self.TextStdAddress_Insert.setGeometry(QRect(660, 580, 171, 41))
        self.TextStdAddress_Insert.setFont(font1)
        self.TextStdAddress_Insert.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom:2px solid rgba(105,118,132,255);\n"
"color:rgba(255,255,255,230);\n"
"padding-bottom:7px;")
        ...
        self.TextClsID_Insert.setGeometry(QRect(850, 580, 171, 41))
...
"padding-bottom:7px;")
        ...
        self.TextClsID_Update.setGeometry(QRect(850, 650, 171, 41))
...
"color:rgba(255,255,255,230);\n"
"padding-bottom:7px;")
        self.TextStdName_Update = QLineEdit(self.widget)
        self.TextStdName_Update.setObjectName(u"TextStdName_Update")
        self.TextStdName_Update.setGeometry(QRect(470, 650, 171, 41))
        self.TextStdName_Update.setFont(font1)
        self.TextStdName_Update.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom:2px solid rgba(105,118,132,255);\n"
"color:rgba(255,255,255,230);\n"
"padding-bottom:7px;")
        self.TextStdID_Update = QLineEdit(self.widget)
        self.TextStdID_Update.setObjectName(u"TextStdID_Update")
        self.TextStdID_Update.setGeometry(QRect(280, 650, 171, 41))
        self.TextStdID_Update.setFont(font1)
        self.TextStdID_Update.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom:2px solid rgba(105,118,132,255);\n"
"color:rgba(255,255,255,230);\n"
"padding-bottom:7px;")
        self.TextStdAddress_Update = QLineEdit(self.widget)
        self.TextStdAddress_Update.setObjectName(u"TextStdAddress_Update")
        self.TextStdAddress_Update.setGeometry(QRect(660, 650, 171, 41))
        self.TextStdAddress_Update.setFont(font1)
        self.TextStdAddress_Update.setStyleSheet(u"background-color:rgba(0,0,0,0);\n"
"border:none;\n"
"border-bottom:2px solid rgba(105,118,132,255);\n"
"color:rgba(255,255,255,230);\n"
"padding-bottom:7px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel.setText(QCoreApplication.translate("Form", u"Student Table", None))
        self.bg.setText("")
        self.bg_2.setText("")
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("Form", u"StudentID", None));
        ___qtablewidgetitem1 = self.TableData.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Form", u"StudentName", None));
        ___qtablewidgetitem2 = self.TableData.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("Form", u"StudentAddress", None));
        ___qtablewidgetitem3 = self.TableData.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("Form", u"ClassID", None));
        ...
        self.TextStdID_Insert.setPlaceholderText(QCoreApplication.translate("Form", u"StdID", None))
        self.TextStdName_Insert.setPlaceholderText(QCoreApplication.translate("Form", u"StdName", None))
        self.TextStdAddress_Insert.setPlaceholderText(QCoreApplication.translate("Form", u"StdAddress", None))
        ...
        self.TextStdName_Update.setPlaceholderText(QCoreApplication.translate("Form", u"StdName", None))
        self.TextStdID_Update.setPlaceholderText(QCoreApplication.translate("Form", u"StdID", None))
        self.TextStdAddress_Update.setPlaceholderText(QCoreApplication.translate("Form", u"StdAddress", None))
    # retranslateUi
