...
################################################################################
## Form generated from reading UI file 'SubjectWindow - Copy.ui'
##
...
"padding-bottom:7px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.TextSbjID_Insert.setPlaceholderText(QCoreApplication.translate("Form", u"ClsID", None))
        self.TextSbjName_Insert.setPlaceholderText(QCoreApplication.translate("Form", u"ClsName", None))
        self.TextSbjUnit_Insert.setPlaceholderText(QCoreApplication.translate("Form", u"ClsYear", None))
        self.TextSbjName_Update.setPlaceholderText(QCoreApplication.translate("Form", u"ClsName", None))
        self.TextSbjID_Update.setPlaceholderText(QCoreApplication.translate("Form", u"ClsID", None))
        self.TextSbjUnit_Update.setPlaceholderText(QCoreApplication.translate("Form", u"ClsYear", None))
    # retranslateUi
